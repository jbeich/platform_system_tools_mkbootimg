...
impl core::fmt::Display for BootError {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let str = match self {
            ...
            Self::UnknownVersion => "Header version is not supported",
...
impl<B: ByteSlice + PartialEq> VendorBootHdr<B> {
    ...
    pub fn parse_vendor_boot_image(buffer: B) -> BootResult<Self> {
        ...
        match version {
            1 => Err(BootError::UnknownVersion),
            2 => Err(BootError::UnknownVersion),
            3 => {
                let (head, _) =
...
mod tests {
    ...
    fn parse_v0() {
        ...
        let expected =
            Ok(BootImg::V0Hdr(LayoutVerified::<&[u8], boot_img_hdr_v0>::new(&buffer).unwrap()));
    ...
    fn parse_v1() {
        ...
        let expected =
            Ok(BootImg::V1Hdr(LayoutVerified::<&[u8], boot_img_hdr_v1>::new(&buffer).unwrap()));
        assert_eq!(BootImg::parse_boot_image(&buffer[..]), expected);
    }
    ...
    fn parse_v2() {
        ...
        let expected =
            Ok(BootImg::V2Hdr(LayoutVerified::<&[u8], boot_img_hdr_v2>::new(&buffer).unwrap()));
        assert_eq!(BootImg::parse_boot_image(&buffer[..]), expected);
    }
    ...
    fn parse_v3() {
        ...
        let expected =
            Ok(BootImg::V3Hdr(LayoutVerified::<&[u8], boot_img_hdr_v3>::new(&buffer).unwrap()));
        assert_eq!(BootImg::parse_boot_image(&buffer[..]), expected);
    }
    ...
    fn parse_v4() {
        ...
        let expected =
            Ok(BootImg::V4Hdr(LayoutVerified::<&[u8], boot_img_hdr_v4>::new(&buffer).unwrap()));
        assert_eq!(BootImg::parse_boot_image(&buffer[..]), expected);
    }
