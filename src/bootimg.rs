...
mod tests {
    ...
    fn parse_v0() {
        ...
        let expected = Ok(BootImg::V0Hdr(
            LayoutVerified::<&[u8], BootImgHdrV0>::new(&buffer).unwrap(),
        ));
    ...
    fn parse_v1() {
        ...
        let expected = Ok(BootImg::V1Hdr(
            LayoutVerified::<&[u8], BootImgHdrV1>::new(&buffer).unwrap(),
        ));
        assert_eq!(BootImg::parse_boot_image(&buffer[..]), expected);
    }
    ...
    fn parse_v2() {
        ...
        let expected = Ok(BootImg::V2Hdr(
            LayoutVerified::<&[u8], BootImgHdrV2>::new(&buffer).unwrap(),
        ));
        assert_eq!(BootImg::parse_boot_image(&buffer[..]), expected);
    }
    ...
    fn parse_v3() {
        ...
        let expected = Ok(BootImg::V3Hdr(
            LayoutVerified::<&[u8], BootImgHdrV3>::new(&buffer).unwrap(),
        ));
        assert_eq!(BootImg::parse_boot_image(&buffer[..]), expected);
    }
    ...
    fn parse_v4() {
        ...
        let expected = Ok(BootImg::V4Hdr(
            LayoutVerified::<&[u8], BootImgHdrV4>::new(&buffer).unwrap(),
        ));
        assert_eq!(BootImg::parse_boot_image(&buffer[..]), expected);
    }
