...
def load_gki_info(gki_info, extra_args):
    """Loads settings from |gki_info| file into |extra_args|."""
    ...
    info_dict = load_dict_from_file(gki_info)
    # Currently just load the value of 'certify_bootimg_extra_args'.
...
def certify_bootimg_zip(boot_img_zip, output_zip, algorithm, key, extra_args):
    ...
    with tempfile.TemporaryDirectory() as unzip_dir:
        ...
        load_gki_info(os.path.join(unzip_dir, 'gki-info.txt'), extra_args)
