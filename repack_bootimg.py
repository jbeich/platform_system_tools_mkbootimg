        ...
        while offset <= len(data)-110:
            ...
            if name == 'TRAILER!!!':
                ...
                if stat.S_ISCHR(mode):
                    self.ramdisk_nodes.append('nod {} 0{} {} {} {} {} {}'.format(name, oct(stat.S_IMODE(mode))[2:], uid, gid, 'c', rmaj, rmin))
                elif stat.S_ISBLK(mode):
                    self.ramdisk_nodes.append('nod {} 0{} {} {} {} {} {}'.format(name, oct(stat.S_IMODE(mode))[2:], uid, gid, 'b', rmaj, rmin))
