...
def parse_cmdline():
    ...
    parser.add_argument('--format', choices=['text', 'mkbootimg'],
                        default='text',
                        help='output format ('
                        'text: Pretty-printed text format designed for '
                        'human-consumption; '
                        'mkbootimg: Argument strings that can be passed to '
                        'mkbootimg to reconstruct the boot image; '
                        'default: text)')
