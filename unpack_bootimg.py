...
def unpack_vendor_bootimage(args):
    ...
    if header_version > 3:
        ...
        num_boot_ramdisk_table_pages = get_number_of_pages(vendor_ramdisk_table_size,
            page_size)
        ...
        print(']')
        bootconfig_offset = page_size * (num_boot_header_pages + num_boot_ramdisk_pages
                             + num_boot_dtb_pages + num_boot_ramdisk_table_pages)
        image_info_list.append((bootconfig_offset, vendor_bootconfig_size, 'bootconfig'))
