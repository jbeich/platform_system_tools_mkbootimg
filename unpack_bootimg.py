...
# Returns mkbootimg.py arguments for v0, v1 and v2 boot.img format.
def get_boot_image_v2_and_below_args(
    ...
    # dtb is added in boot image v2, and might be absent in v1 or v0.
    if dtb_load_address is not None:
    ...
    mkbootimg_args['extra_cmdline'] = extra_cmdline
